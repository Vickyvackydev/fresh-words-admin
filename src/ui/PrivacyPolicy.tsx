    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-slate-200/50 p-8 sm:p-12 shadow-sm space-y-8 relative overflow-hidden">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-slate-600">
          <p>
            At <strong>Fresh Devotionals</strong>, we are committed to
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              using the application. This includes:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <strong>Bookmarks:</strong> Favorite/bookmarked devotionals are
                saved locally on your device or linked securely to your
                anonymous device ID.
              </li>
              <li>
                <strong>Feedback:</strong> If you submit feedback, we collect
                your name, email address, and message details to address your
                comments.
              </li>
              <li>
                <strong>Usage Metrics:</strong> We compile anonymous analytics
                about devotional read counts to help us understand engagement
          ...
          <div className="space-y-3">
            ...
            <p>
              We utilize the collected information for the following core
              purposes:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                To store bookmarks, customize reading schedules, and personalise
                your devotion feed.
              </li>
              <li>
                To process and reply to support inquiries and feedback
                submissions.
              </li>
              <li>
                To compile aggregate, non-identifiable usage statistics for
                content enhancement.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              We prioritize the safety of your information. Feedback comments
              and database records are securely hosted on protected cloud
              databases. We utilize standard SSL/TLS encryption for all data
              transit. We do not sell or lease user information to third-party
              advertisers.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              The app may display external scripture references or allow sharing
              quotes via standard social applications. We are not responsible
              for the privacy practices of external websites linked within
              devotional content.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              about how we safeguard your data.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              If you have any questions, feedback, or concerns regarding our
              privacy standards, please reach out to us at{" "}
              <strong>support@freshdevotionals.com</strong>.
            </p>
          </div>
        </div>
