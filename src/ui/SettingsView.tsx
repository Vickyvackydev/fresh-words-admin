          ...
          <div className="bg-white rounded-md p-6 shadow-xs space-y-5">
            ...
            <div className="flex gap-3 justify-end pt-4 border-t border-slate-50">
              <button
                ...
                className="px-5 py-2.5 bg-orange-600 hover:bg-orange-500 text-white rounded-md text-xs font-semibold tracking-wide flex items-center gap-1.5 cursor-pointer shadow-none transition-all hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-60 disabled:cursor-not-allowed"
              >
